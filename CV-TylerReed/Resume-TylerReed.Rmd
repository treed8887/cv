...
tribble(
  ...
  "Java",
  "SAS",
  "Data Mining: Naive Bayes, Support Vector Machines, Neural Networks, Random Forests, Visualizations",
  "Statistical Modeling/Analysis: ANOVA, MLR, EDA",
) %>% 
  brief_entries(
    Title,
  )
...
<!-- design software process for analyzing data -->
<!-- • build a model for common data mining technique such as Naive Bayes -->
<!-- • evaluate the results - for effectiveness and appropriateness - of different models on the same data -->
<!-- • describe the nature of a data set using software tools such as clustering and visualization -->
...
tribble(
  ...
  "2010-2016", "IT Project Mgr. | IT Support Ops Supervisor", "Missionary Training Center",
